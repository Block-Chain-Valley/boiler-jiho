...
export interface UniswapV2Router02ABIInterface extends utils.Interface {
  functions: {
...
export interface UniswapV2Router02ABI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV2Router02ABIInterface;
